...
void SelectFile_Func10() {
  static const uint8 kSelectFile_Func10_Tab[173] = {
  ...
  static const uint8 kSelectFile_Func10_Tab1[73] = {
  ...
  static const uint16 kSelectFile_Func10_Dst[3] = {0x3c, 0x64, 0x8c};
  static const uint8 kSelectFile_Func10_FaerieX[4] = {36, 36, 36, 28};
  static const uint8 kSelectFile_Func10_FaerieY[4] = {87, 111, 135, 191};

  vram_upload_offset = 0xac;
  memcpy(vram_upload_data, kSelectFile_Func10_Tab, 173);

  for (int k = 0; k != 3; k++) {
    if (selectfile_arr1[k] & 1) {
      uint16 *name = (uint16 *)(g_zenv.sram + 0x500 * k + kSrmOffs_Name);
      uint16 *dst = vram_upload_data + kSelectFile_Func10_Dst[k] / 2;
      for (int i = 0; i != 6; i++) {
        uint16 t = *name++ + 0x1800;
        dst[0] = t;
        dst[10] = t + 0x10;
  ...
  if (a & 0x2c) {
    ...
    memcpy(vram_upload_data + 26, kSelectFile_Func10_Tab1, 73);
    if (selectfile_R16 != 2) {
...
void SelectFile_Func8() {
  static const uint16 kSelectFile_Func8_Dst[2] = {4, 0x1e};
  for (int j = 1; j >= 0; j--) {
    uint16 *dst = vram_upload_data + kSelectFile_Func8_Dst[j] / 2;
    for (int i = 0; i != 11; i++)
      dst[i] = 0xa9;
  }
}
...
void SelectFile_Func12() {
  ...
  static const uint8 kSelectFile_Func12_Tab0[133] = {
  ...
  static const uint8 kSelectFile_Func12_Tab2[49] = {
  ...
  static const uint8 kSelectFile_Func12_FaerieX[3] = {0x8c, 0x8c, 0x1c};
  static const uint8 kSelectFile_Func12_FaerieY[3] = {0x67, 0x7f, 0xbf};
  static const uint16 kSelectFile_Func12_Dst[2] = {0x38, 0x60};
  static const uint16 kSelectFile_Func12_Tab1[3] = {0x18e7, 0x18e8, 0x18e9};
  memcpy(vram_upload_data, kSelectFile_Func12_Tab0, 133);

  for (int k = 0, j = 0; k != 3; k++) {
    if (k * 2 == selectfile_R20)
      continue;

    uint16 *dst = vram_upload_data + kSelectFile_Func12_Dst[j++] / 2;
    uint16 t = kSelectFile_Func12_Tab1[k];
    dst[0] = t;
    dst[10] = t + 0x10;
    dst += 2;
  ...
  if (a & 0x2c) {
    ...
    memcpy(vram_upload_data + 26, kSelectFile_Func12_Tab2, 49);
    if (selectfile_R16 == 0) {
...
void SelectFile_Func15() {
  static const uint8 kSelectFile_Func15_Tab[253] = {
  ...
  static const uint8 kSelectFile_Func15_Tab2[101] = {
  ...
  static const uint8 kSelectFile_Func15_FaerieX[4] = {36, 36, 36, 28};
  static const uint8 kSelectFile_Func15_FaerieY[4] = {103, 127, 151, 191};
  memcpy(vram_upload_data, kSelectFile_Func15_Tab, 253);
  for (int k = 0; k < 3; k++) {
    if (selectfile_arr1[k])
      SelectFile_Func17(k);
  }
  ...
  if (a) {
    ...
    memcpy(vram_upload_data, kSelectFile_Func15_Tab2, 101);
    submodule_index++;
    if (selectfile_R16 != 2) {
      uint16 *dst = vram_upload_data + selectfile_R16 * 6;
      dst[0] = 0x6762;
...
void SelectFile_Func20() {
  static const uint16 kSelectFile_Func20_Add[2] = {1, 0xff};
  static const int16 kSelectFile_Func20_Cmp[2] = {0x20, 0xff};
  static const int16 kSelectFile_Func20_Set[2] = {0, 0x1f};
  if (joypad1H_last & 3) {
    int k = (joypad1H_last & 3) - 1;
    selectfile_var10 = k;
    selectfile_var9++;
    uint8 t = selectfile_var3 + kSelectFile_Func20_Add[k];
    if (t == kSelectFile_Func20_Cmp[k])
      t = kSelectFile_Func20_Set[k];
    selectfile_var3 = t;
  }
}

void SelectFile_Func21() {
  static const int8 kSelectFile_Func21_Add[2] = {1, -1};
  static const int8 kSelectFile_Func21_Cmp[2] = {4, -1};
  static const int8 kSelectFile_Func21_Set[2] = {0, 3};
  ...
  if (a) {
    if ((a * 2 | selectfile_var5) == 0x10 || (a * 4 | selectfile_var5) == 0x13) {
     ...
     a >>= 2;
    int t = selectfile_var5 + kSelectFile_Func21_Add[a-1];
    if (t == kSelectFile_Func21_Cmp[a-1])
      t = kSelectFile_Func21_Set[a-1];
    selectfile_var5 = t;
...
void SelectFile_Func22(int k, uint16 chr) {
  static const uint16 kSelectFile_Func22_Tab[6] = {0x84, 0x86, 0x88, 0x8a, 0x8c, 0x8e};
  uint16 *dst = vram_upload_data;
  uint16 a = kSelectFile_Func22_Tab[k] | 0x6100;
  dst[0] = swap16(a);
  dst[1] = 0x100;
  dst[2] = 0x1800 | chr;
  dst[3] = swap16(a + 0x20);
...
void Module_NamePlayer_3() {
  ...
  if (!(filtered_joypad_H & 0x10)) {
    ...
    if (t == 0x5a) {
      ...
      SelectFile_Func22(selectfile_var4, chr);
      if (++selectfile_var4 == 6)
        selectfile_var4 = 0;
      return;
    }
...
void Module04_NameFile() {
  ...
  case 3: Module_NamePlayer_3(); break;
  }
}
